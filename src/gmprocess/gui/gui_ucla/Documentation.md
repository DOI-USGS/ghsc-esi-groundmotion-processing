...
![HumanReviewGUI/img/interface2.png](https://github.com/meramossepu/HumanReviewGUI/blob/main/img/interface2.png)*Figure 1: Interface of Graphic User Interface for human review*
...
![HumanReviewGUI/img/fchp_before2.png](https://github.com/meramossepu/HumanReviewGUI/blob/main/img/fchp_before2.png)*Figure 2: Example trace with an automated selected fchp resulting in an irregular displacement time series*

![HumanReviewGUI/img/fchp_after2.png](https://github.com/meramossepu/HumanReviewGUI/blob/main/img/fchp_after2.png)*Figure 3: Example trace shown in Figure 2 with a modified fchp resulting in a regular displacement time series*
...
![HumanReviewGUI/img/fclp_before2.png](https://github.com/meramossepu/HumanReviewGUI/blob/main/img/fclp_before2.png)*Figure 4: Example trace without fclp resulting in an irregular response spectra shape*

![HumanReviewGUI/img/fclp_after2.png](https://github.com/meramossepu/HumanReviewGUI/blob/main/img/fclp_after2.png)*Figure 5: Example trace shown in Figure 4 with fclp resulting in a flat response spectra at short periods*
...
![HumanReviewGUI/img/rejected2.png](https://github.com/meramossepu/HumanReviewGUI/blob/main/img/rejected2.png)*Figure 6: Example trace with significant noise that should be rejected*
