...
def generate_workspace():
    ...
    h5.create_dataset("QuakeML", data=np.ones((14000,), dtype="uint8"))

    waveforms = h5.create_group("Waveforms")
    st00 = waveforms.create_group("NET.ST00")
    st00.create_dataset(
        "NET.ST00.00.HN1__TSTART_TEND__EV0_label",
        data=np.ones((3000,), dtype="float64"),
    )
    st00.create_dataset(
        "NET.ST00.00.HN2__TSTART_TEND__EV0_label",
        data=np.ones((3000,), dtype="float64"),
    )
    st00.create_dataset(
        "NET.ST00.00.HNZ__TSTART_TEND__EV0_label",
        data=np.ones((3000,), dtype="float64"),
    )
    st00.create_dataset(
        "NET.ST00.00.HN1__TSTART_TEND__EV1_label",
        data=np.ones((4000,), dtype="float64"),
    )
    st00.create_dataset(
        "NET.ST00.00.HN2__TSTART_TEND__EV1_label",
        data=np.ones((4000,), dtype="float64"),
    )
    st00.create_dataset(
        "NET.ST00.00.HNZ__TSTART_TEND__EV1_label",
        data=np.ones((4000,), dtype="float64"),
    )
    st01 = waveforms.create_group("NET.ST01")
    st01.create_dataset(
        "NET.ST01.10.HNE__TSTART_TEND__EV0_label",
        data=np.ones((3000,), dtype="float64"),
    )
    st01.create_dataset(
        "NET.ST01.10.HNN__TSTART_TEND__EV0_label",
        data=np.ones((3000,), dtype="float64"),
    )
    st01.create_dataset(
        "NET.ST01.10.HNZ__TSTART_TEND__EV0_label",
        data=np.ones((3000,), dtype="float64"),
    )
    ...
    station_metrics.create_dataset("NET.ST00", data=np.ones((2000,), dtype="uint8"))
    station_metrics.create_dataset("NET.ST01", data=np.ones((5000,), dtype="uint8"))
    ...
    provenance.create_dataset("NET.ST00_EV0", data=np.ones((3000,), dtype="uint8"))
