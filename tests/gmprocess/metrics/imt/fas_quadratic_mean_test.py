...
def test_fas():
    ...
    """
    fas_file = constants.TEST_DATA_DIR / "fas_quadratic_mean.pkl"
    ...
    config["metrics"]["output_imcs"] = ["quadratic_mean"]
    ...
    target_repr = (
        "3 metric(s) in list:\n  FAS(T=0.0300, B=20.0): QUADRATIC_MEAN=0.001\n"
        "  FAS(T=0.1410, B=20.0): QUADRATIC_MEAN=0.034\n"
